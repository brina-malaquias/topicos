...
public class PodDescartavelDTO 
{
    ...
    public PodDescartavelDTO(String marca, String puffs, String valor, String sabor) 
    {
        this.marca = marca;
        this.puffs = puffs;
        this.valor = valor;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PodDescartavelDTO other = (PodDescartavelDTO) obj;
        if (marca == null) {
            if (other.marca != null)
                return false;
